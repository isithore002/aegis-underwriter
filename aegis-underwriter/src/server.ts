  ...
  try {
    ...
    if (lowerMsg.includes("repay") || lowerMsg.includes("repayment")) {
      ...
      try {
        ...
        console.log(`[REPAY] Response about to be sent with repaymentDetails:`, { amount: repaymentInfo.amount, borrowerAddress: addressMatch[0], contractAddress: repaymentInfo.contractAddress, usdtAddress: USDT_ADDRESS, ledgerAddress: LEDGER_ADDRESS });
        return res.json({
